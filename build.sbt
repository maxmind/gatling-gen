...
libraryDependencies                += "com.github.julien-truffaut" %% "monocle-core"              % monocleV                            withSources() withJavadoc()
libraryDependencies                += "com.github.julien-truffaut" %% "monocle-generic"           % monocleV                            withSources() withJavadoc()
libraryDependencies                += "com.github.julien-truffaut" %% "monocle-macro"             % monocleV                            withSources() withJavadoc()
libraryDependencies                += "com.github.julien-truffaut" %% "monocle-state"             % monocleV                            withSources() withJavadoc()
