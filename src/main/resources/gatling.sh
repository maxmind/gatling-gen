...
GATLING_CLASSPATH="$GATLING_HOME/lib/*:$GATLING_HOME/user-files:$COMMON_CLASSPATH:$GATLING_CONF"
...
CMD="java $JAVA_OPTS -cp '$GATLING_CLASSPATH' io.gatling.app.Gatling $USER_ARGS"

echo "# Env: home='${GATLING_HOME}', opts='${JAVA_OPTS}'," \
 "cp='${GATLING_CLASSPAH}', user='${USER_ARGS}', conf='${GATLING_CONF}'"
echo "# Run: '$CMD"
