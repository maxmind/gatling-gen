...
import com.maxmind.gatling.{BaseSpec, SampleSize}
...
class ThirdPartySpec extends BaseSpec {
  ...
  "Examples of how Specs2, ScalaCheck, and Gatling can work together".title
  ...
  Note: Randomness quality tests are at Randomness.scala""" >> {
    ...
    at least one of each = (2^1,000 + 1) / 3^999 =~ 2*10e-176""" >> {
      ...
      implicit val defaultSampleSizeImplicit = SampleSize(1000)
